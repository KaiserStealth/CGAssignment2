...
uniform layout(binding = 6) sampler1D specular_ramp;
...
void main() {
    ...
    {
        specular.r = texture(specular_ramp, specular.r).r;
        specular.g = texture(specular_ramp, specular.g).g;
        specular.b = texture(specular_ramp, specular.b).b;
    }
